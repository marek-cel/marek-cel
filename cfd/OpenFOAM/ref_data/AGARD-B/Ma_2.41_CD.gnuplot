...
plot \
  "NACA-TN-3300/Ma_2.41_CD.csv" using 1:2 with linespoints ls 1 title "NACA-TN-3300", \
  "OpenFOAM/Ma_2.41_CD.csv" using 1:2 with linespoints ls 2 title "OpenFOAM",
