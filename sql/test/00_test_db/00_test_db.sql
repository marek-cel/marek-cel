...
--
-- Host: localhost:3306
-- Czas generowania: 11 Paź 2021, 20:35
-- Wersja serwera: 8.0.26-0ubuntu0.20.04.3
-- Wersja PHP: 7.4.3
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `groups` (`group_id`) ON DELETE RESTRICT;
COMMIT;
